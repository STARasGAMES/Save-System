...
namespace SaG.SaveSystem.Editor.Tools
{
    ...
    public class ValidateHierarchy
    {
        ...
        private static Dictionary<Transform, HashSet<MonoBehaviour>> validateableMonobehaviours =
            new Dictionary<Transform, HashSet<MonoBehaviour>>();
        ...
        public static void Add(MonoBehaviour monoBehaviour)
        {
            ...
            isPrefab = PrefabUtility.GetCorrespondingObjectFromSource(monoBehaviour.gameObject) == null &&
                       PrefabUtility.GetPrefabInstanceHandle(monoBehaviour.gameObject) != null;
#elif UNITY_2018_1_OR_NEWER
            isPrefab =
 PrefabUtility.GetCorrespondingObjectFromSource(monoBehaviour.gameObject) == null && PrefabUtility.GetPrefabObject(monoBehaviour.gameObject) != null;
#else
            isPrefab =
 PrefabUtility.GetPrefabParent(monoBehaviour.gameObject) == null && PrefabUtility.GetPrefabObject(monoBehaviour.gameObject) != null;
#endif
            if (isPrefab)
                return;
